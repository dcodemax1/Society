...
function AdminLogin({ onClose }) {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen">
      <div className="bg-white rounded-2xl shadow-xl overflow-hidden" style={{ width: "672px", height: "450px" }}>
        ...
        <div className="flex items-center justify-center bg-gradient-to-br from-emerald-100 via-yellow-100 to-emerald-200 p-3 md:p-4 relative z-10 lg:col-span-1">
          ...
          {step === 3 && (
            <div className="space-y-6">
              <div className="text-center mb-8">
                <h1 className="text-3xl font-bold text-slate-900 mb-2">Create Password</h1>
                <p className="text-sm text-slate-600">Set a secure password for your account</p>
              </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <button
                      ...
                      className="absolute right-3 top-1/2 -translate-y-1/2 text-slate-400 hover:text-slate-600"
                    >
                      {showLoginPassword ? <MdVisibilityOff className="w-5 h-5" /> : <MdVisibility className="w-5 h-5" />}
                    </button>
                  </div>
                </div>
                <button
